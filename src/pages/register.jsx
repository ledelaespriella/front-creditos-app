        ...
        <>
            <div className="container">
                <div className="py-5 text-center">
                    <h2>Registro</h2>
                    <p className="lead mt-3">Para acceder a los productos ofrecidos por el Banco Caja Social, por favor ingrese
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row g-3">
                        ...
                        <div className="col-sm-6">
                            <label for="appelidos" className="form-label">Apellidos</label>
                            <input {...register('lastName')} type="text" className="form-control"></input>
                        ...
                        <div className="col-12">
                            ...
                            <div className="input-group">
                                ...
                                <input {...register('mail')} type="text" className="form-control" placeholder="correo@gmail.com"></input>
                        ...
                        <div className="col-6">
                            <label for="passw2" className="form-label">Confirmar contraseña</label>
                            <input {...register('passw2')} type="password" className="form-control"></input>
                            <p className="text-danger">{errors.passw2?.message}</p>
                        </div>

                        <div className="col-md-4">
                            <label for="typeId" className="form-label">Tipo de documento</label>
                        ...
                        <div className="col-md-3">
                            <label for="dateExp" className="form-label">Fecha de expedición</label>
                            <input {...register('dateExp')} type="date" className="form-control"></input>
                            <p className="text-danger">{errors.dateExp?.message}</p>
                        </div>

                        <div className="col-6">
                            <label for="incomes" className="form-label">Ingresos</label>
                            <input {...register('incomes')} type="number" className="form-control"></input>
                            <p className="text-danger">{errors.incomes?.message}</p>
                        </div>

                        <div className="col-6">
                            <label for="expenses" className="form-label">Egresos</label>
                            <input {...register('expenses')} type="number" className="form-control"></input>
                    ...
                    <div className="form-check">
                        ...
                        />
                        <label className="form-check-label" for="save-info">Acepta la politica de privacidad de datos</label>
                    </div>
